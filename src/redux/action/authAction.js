...
import { LoginProses, RegisterProses, authMeProcess, RegisterProsesP } from '../../api/authApi';
...
export function authRegisterP(payload) {
  return async (dispatch) => {
    try {
      let response = await RegisterProsesP(payload);
      let data = response.data;
      console.log('data', data);
